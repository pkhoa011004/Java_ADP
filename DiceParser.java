...
public class DiceParser {
	private static class StringStream{
		...
		public void restore(StringStream ss){
			this.buff=new StringBuffer(ss.buff);// add "this.buff"
		}
	...
	private static Vector<DieRoll> parseXDice(StringStream ss) {
		...
		for(int i=0;i<num;i++){// change fore to for
			ans.add(dr);
		}
		return ans;
	}
	...
	private static void test(String s) {// change staticvoid to static void
